...
/*    fun openFragment(view: View) {
        val fragment = when(view.id) {
            R.id.btnPrivacyPolicy -> PrivacyPolicyFragment() // PrivacyPolicyFragment()는 프래그먼트 클래스 이름입니다.
            R.id.btnUserAgreement -> UserAgreementFragment() // UserAgreementFragment()는 프래그먼트 클래스 이름입니다.
            else -> return // 다른 버튼이면 함수를 종료합니다.
        }
